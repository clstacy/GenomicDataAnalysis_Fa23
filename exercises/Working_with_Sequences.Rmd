...
rfastp_report <- rfastp(read1 = "/Users/clstacy/Desktop/subset_phenol_heat_rep4.fastq.gz", #note rel path doesn't work here on mac.
...
Now, we can loop through all of the files to perform filtering and trimming. Note there are many arguments that can be modified. Use ?rfastp to learn more.
...
if command_exists /opt/homebrew/bin/fastqc; then
  ...
  /opt/homebrew/bin/fastqc $DATA_DIR/filtered/*.fastq.gz
  if [ $? -ne 0 ]; then
...
```{bash multiqc file}
browseURL("https://htmlpreview.github.io/?https://github.com/clstacy/GenomicDataAnalysis_Fa23/blob/main/outputs/fastqc/merged_multiqc.html")
```
