...
```{r}
# need to loop to get DE genes in each contrast.
...
write_rds(decideTests_edgeR, "~/Documents/GitHub/GenomicDataAnalysis_Fa23/analysis/yeast_decideTests_allContrasts_edgeR.tsv")
```
