...
trimmed.fastq.files <- list.files(path = dir_trimmed.fq_files, 
                                  pattern = ".fastq.gz$", 
                                  full.names = TRUE)
trimmed.fastq.files
```
...
reference_genome = "/Users/clstacy/Desktop/Reference/Saccharomyces_cerevisiae.R64-1-1.dna.toplevel.fa.gz"

index_reference_genome = "/Users/clstacy/Desktop/Reference/sacCer3"
...
#conda install --offline salmon-1.10.1.tar.gz

# make salmon work on M1/2 mac OS
