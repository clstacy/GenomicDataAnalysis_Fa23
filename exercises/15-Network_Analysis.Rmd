...
text(sft$fitIndices[, 1],
     ...
     cex = cex1, col = "red")
```
It looks like a higher power would better fit this data. Let's try with 12. You can try changing to 18 and see how the results change.
...
plot(network_graph_data_DE, 
     layout=layout.fruchterman.reingold(network_graph_data_DE, niter=5000),
     vertex.size=3, edge.arrow.size=0.1, 
     vertex.label.cex = 0.01,  # increase this value to see gene names
     vertex.label.color= "black", rescale=TRUE, ylim=c(-1,1),xlim=c(-1,1),
