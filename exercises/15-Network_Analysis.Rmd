...
cowplot::ggdraw(test_plot)+
   cowplot::draw_label("Airway Data", color = "Black", size = 14, x=0.1,y=0.97,hjust=0.65,fontface="bold")
...
expr_normalized_DE %>%
  ...
  ggplot(., aes(x=replicate, y=value, group=gene_id)) +
  geom_line(aes(color = module),
            alpha = 0.2) +
  theme_bw() +
  theme(
