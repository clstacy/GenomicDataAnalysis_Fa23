...
FC_list <-
  readr::read_tsv(
    "~/Documents/GitHub/GenomicDataAnalysis_Fa23/data/DE_yeast_TF_stress.txt.gz",
...
What gene list do you think has the most interesting biological meaning for motif analysis? One comparison to consider is the genes that are most different in the EtOH response between WT and Msn2/4∆∆ samples. Let's get that list of genes now:
```{r}
