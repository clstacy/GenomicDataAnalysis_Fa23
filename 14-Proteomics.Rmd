...
# Example Usage:
combined_gene_list <- c(list_c(ID_transcriptome_list_up), list_c(ID_transcriptome_list_down))

# Analyze combined list
...
# Analyze only upregulated genes
perform_correlation_analysis(
  res_all_proteome,
  res_all_transcriptome,
...
# Analyze only downregulated genes
perform_correlation_analysis(
  res_all_proteome,
  res_all_transcriptome,
