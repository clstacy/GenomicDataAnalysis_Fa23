...
We generated those counts on a subset of the fastq files, but we can load the complete count file with the command below. 
```{r altLoad-fc}
...
Question 5: We analyzed the counts generated by Rsubread. Load in the counts generated by Salmon and look at the same contrast we did in class. What differences and similarities do you see?
