...
legend("top", legend=levels(group),
...
```{r}
con <- makeContrasts(heat - unstressed, levels=design)
res <- glmQLFTest(fit, #coef="heat")
                  contrast = con)
```
